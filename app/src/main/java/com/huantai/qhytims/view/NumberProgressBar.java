...
//    private int totalMovedLength;
    ...
    private void initData() {
        ...
        // 已完成进度条画笔的属性
        paintInit.setColor(context.getResources().getColor(R.color.main_color));
        ...
        // 大圆画笔
        paintEndBig.setColor(context.getResources().getColor(R.color.main_color));
        paintEndBig.setAntiAlias(true);
        paintEndBig.setStyle(Paint.Style.FILL);


        // 百分比文字画笔的属性
        int paintTextSizePx = sp2px(context, 14);  //设置百分比文字的尺寸
        paintText.setColor(context.getResources().getColor(R.color.main_color));
